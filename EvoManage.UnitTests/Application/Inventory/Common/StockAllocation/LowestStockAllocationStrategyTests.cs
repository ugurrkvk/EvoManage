...
public sealed class LowestStockAllocationStrategyTests
{
    private readonly Mock<IStockReadRepository> _stockReadRepository = new();

    private LowestStockAllocationStrategy CreateStrategy()
        => new(_stockReadRepository.Object);

    [Fact]
    public async Task AllocateAsync_WithSingleLowestStockLocationHavingEnoughStock_ShouldReturnSingleAllocation()
    {
        // Arrange
        ...
        Assert.Equal(20, allocation.LocationId);
        Assert.Equal(20m, allocation.Quantity);
    }

    [Fact]
    public async Task AllocateAsync_WithQuantitySpanningMultipleLocations_ShouldAllocateFromLowestStockFirst()
    {
        // Arrange
        SetupAvailableStocks(
        [
        ...
        Assert.Collection(
            ...
            first =>
            {
                ...
                Assert.Equal(30, first.LocationId);
            ...
            second =>
            {
                ...
                Assert.Equal(20m, second.Quantity);
            });
    }

    [Fact]
    public async Task AllocateAsync_WithEqualStock_ShouldUseLowerLocationIdFirst()
    {
        // Arrange
        SetupAvailableStocks(
        [
        ...
        Assert.Collection(
            ...
            {
                Assert.Equal(20, second.LocationId);
                Assert.Equal(5m, second.Quantity);
            });
    }
